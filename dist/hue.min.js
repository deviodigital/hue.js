...
control=this.controls.squareDrag;dimensions={w:square.width()-control.width(),h:square.height()-control.height()};square.data('dimensions',dimensions);return dimensions},_isNonHueControl:function(active,type){if(active==='square'&&this.options.controls.strip==='h'){return!0}else if(type==='external'||(type==='h'&&active==='strip')){return!1}
